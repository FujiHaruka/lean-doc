/-
Stage 7d experiment for lean-doc: a copy of `experiments/stage7c/Extract.lean`
(which was byte-identical to stage 7b's) that adds two things and changes
...
Stages 7a / 7b / 7c are left untouched: their numbers are committed and quoted
from `docs/approach.md`, and an extractor that has been edited cannot reproduce
them.
